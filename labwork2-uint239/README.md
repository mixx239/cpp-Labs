# Лабораторная работа 2 — ITMO Endian и тип `uint239_t`

В этой работе реализуется собственный беззнаковый целочисленный тип `uint239_t` размером 239 бит, хранящийся в особом формате ITMO Endian. Основной акцент — на работе с битами, переносами и аккуратной реализации арифметики.

---

## Пример запуска

Сборка проекта и запуск демонстрационного приложения:
...
```text
uint32 value:     2047
as uint239_t:     0000...00011111111111 (shift = 0)

parsed from str:  12345678901234567890
as uint239_t:     0001...010010010010 (shift = 5)

a + b =           12345678901236619937
a - b =           999999999999944953
a * b =           252191122515978649786591215257730
a / b =           987654321
