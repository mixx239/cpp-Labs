# Лабораторная работа 5 — консольный «Морской бой»

Реализуется консольное приложение для игры в морской бой. Взаимодействие с программой происходит через текстовый протокол поверх стандартных потоков ввода и вывода. Приложение может работать как в роли master, так и в роли slave.
...
```bash
cd labwork5-Battleship
cmake -S . -B build
cmake --build build

./build/labwork5-maksimbelov1
```

Дальше с программой общаются текстовыми командами через stdin/stdout.
